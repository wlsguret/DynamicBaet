...
public class DynamicBeat extends JFrame {
	...
	public DynamicBeat() {
		trackList.add(new Track("killThisLove Title Image.png", "killThisLove Start Image.png", "killThisLove Game Image.png",
				"BLACKPINK - Kill This Love.mp3", "BLACKPINK - Kill This Love.mp3", "BLACKPINK - Kill This Love"));
		...
		trackList.add(new Track("Smoking Title Image.png", "Smoking Start Image.png", "Smoking Game Image.jpg",
				"buttonEnteredMusic.mp3", "buttonEnteredMusic.mp3", "Test"));
